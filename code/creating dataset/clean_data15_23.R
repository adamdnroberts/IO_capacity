...
s15_full <- read.csv(
  "raw/Projections/Spring 2015/AMECO16.TXT",
  sep = ";"
)
...
a15_full <- read.csv(
  "raw/Projections/Autumn 2015/AMECO16.TXT",
  sep = ";"
)
...
s16_full <- read.csv(
  "raw/Projections/Spring 2016/AMECO16.TXT",
  sep = ";"
)
...
a16_full <- read.csv(
  "raw/Projections/Autumn 2016/AMECO16.TXT",
  sep = ";"
)
...
s17_full <- read.csv(
  "raw/Projections/Spring 2017/AMECO16.TXT",
  sep = ";"
)
...
a17_full <- read.csv(
  "raw/Projections/Autumn 2017/AMECO16.TXT",
  sep = ";"
)
...
s18_full <- read.csv(
  "raw/Projections/Spring 2018/AMECO16.TXT",
  sep = ";"
)
...
a18_full <- read.csv(
  "raw/Projections/Autumn 2018/AMECO16.TXT",
  sep = ";"
)
...
s19_full <- read.csv(
  "raw/Projections/Spring 2019/AMECO16.TXT",
  sep = ";"
)
...
a19_full <- read.csv(
  "raw/Projections/Autumn 2019/AMECO16.TXT",
  sep = ";"
)
...
s20_full <- read.csv(
  "raw/Projections/Spring 2020/AMECO16.TXT",
  sep = ";"
)
...
a20_full <- read.csv(
  "raw/Projections/Autumn 2020/AMECO16.TXT",
  sep = ";"
)
...
s21_full <- read.csv(
  "raw/Projections/Spring 2021/AMECO16.TXT",
  sep = ";"
)
...
a21_full <- read.csv(
  "raw/Projections/Autumn 2021/AMECO16.TXT",
  sep = ";"
)
...
s22_full <- read.csv(
  "raw/Projections/Spring 2022/AMECO16.TXT",
  sep = ";"
)
...
a22_full <- read.csv(
  "raw/Projections/Autumn 2022/AMECO16.TXT",
  sep = ";"
)
...
s23_full <- read.delim("raw/Projections/Spring 2023/AMECO16.TXT")
...
save(full_dataset15_23, file = "data/full_dataset15_23.Rdata")
